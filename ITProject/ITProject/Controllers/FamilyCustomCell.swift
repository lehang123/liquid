...
//        textView.isScrollEnabled = false
    ...
    override init (style: UITableViewCell.CellStyle, reuseIdentifier:String? ){
        ...
        self.backgroundColor = UIColor(red: 0, green: 255, blue: 255)
...
//        nameView.leftAnchor.constraint(greaterThanOrEqualTo: self.leftAnchor , constant: CGFloat(0.5)).isActive = true
        nameView.leftAnchor.constraint(equalTo: self.leftAnchor, constant: CGFloat(25.0)).isActive = true
//        nameView.leftAnchor.constraint(equalTo: self.leftAnchor).isActive = true
        ...
        positionView.leftAnchor.constraint(lessThanOrEqualTo: self.nameView.rightAnchor , constant: CGFloat(50.0)).isActive = true
//        positionView.leftAnchor.constraint(equalTo: NSLayoutXAxisAnchor()).isActive = true
        ...
        positionView.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        positionView.topAnchor.constraint(equalTo: self.topAnchor).isActive = true
